...
# Database: logc
# Generation Time: 2014-04-28 00:12:20 +0000
# ************************************************************
...
VALUES
	...
	(215,'transcription','I\'m Bradford Barr and how\'d I\'d describe myself is an educator, an artist, an activist, a hacker among other things',12.4416,1397175160,1397175203,30,1,1),
	(216,'transcription','Q: Tell us your name, how\'d you describe yourself',4.63341,1397175232,1397175257,30,1,1),
	(217,'transcription','Q: Tell me about yourself',39.1816,1397175286,1397175293,30,1,1),
	(218,'transcription','I am a software developer by trade. I spend a lot of my spare time building things, mostly small-scale electronics stuff. I do some robotics.',42.3174,1397175305,1397175355,30,1,1),
	(219,'transcription','I do some DIY biology, I do a little bit of machining and wood working. Generally I try to keep busy doing those things.',60.426,1397175355,1397175384,30,1,1),
	(220,'transcription','I try and teach a lot, as often as I can.',73.091,1397175385,1397175397,30,1,1),
	(221,'transcription','Q: And how did you get into this?',78.6514,1397175398,1397175417,30,1,1),
	(222,'transcription','The hacker scene?',80.7076,1397175417,1397175428,30,1,1),
	(223,'transcription','Q: Where did this curiosity come from?',85.6648,1397175429,1397175448,30,1,1),
	(224,'transcription','When I was a kid, I was pretty useless. I didn\'t do much other than play video games all the damn time.',90.168,1397175449,1397175470,30,1,1),
	(225,'transcription','So when I got to college I decided that I was going to change a lot.',97.9169,1397175472,1397175484,30,1,1),
	(226,'transcription','Once I was in college, I learned to program during my sophomore year of school and I totally took with it. I was just good at it, I had a natural aptitude, so I just ran with it.',102.908,1397175484,1397175546,30,1,1),
	(227,'transcription','Wound up studying artificial intelligence and robotics and moved to DC after I graduated and fell in with the hacker scene here and I\'ve learned incredible amounts about embedded programming, electronics, circuit design as well as hardware things like how to run 3d printers and how to deal with different mechanical linkages.',119.121,1397175546,1397175612,30,1,1),
	(228,'transcription','But I really started when I was 19. It wasn\'t something I started with as a child.',145.131,1397175612,1397175630,30,1,1),
	(229,'transcription','Q: How old are you now?',151.378,1397175631,1397175639,30,1,1),
	(230,'transcription','I\'m 25',152.152,1397175642,1397175646,30,1,1),
	(231,'transcription','Q: What video games did you play?',154.75,1397175648,1397175659,30,1,1),
	(232,'transcription','Mega man, yes! [More video game talk]',158.02,1397175662,1397175706,30,1,1),
	(233,'transcription','[More video game talk]',183.73,1397175713,1397175718,30,1,1),
	(234,'transcription','Q: What was happening with computer technology at that time?',203.898,1397186730,1397186744,30,1,1),
	(235,'transcription','So that was in the early 2000s, so computer programming, the Ruby programming language had just started getting popular and web development was getting huge and everyone was doing everything they could to make their web-based startup and things like that.',207.66,1397186754,1397186825,30,1,1),
	(236,'transcription','I went the scientific route as opposed to the professional programmer route and it was a very interesting time because it was right at the cusp of the birth of data science.',225.244,1397186825,1397186871,30,1,1),
	(237,'transcription','So a lot of people right now talk a lot about data visualization and how data informs all of your decisions and these companies talk about big data and how they can farm data from their users and use that in order to provide better service or to do some statistics to gain more information about their products or who they\'re selling to.',241.768,1397186871,1397186952,30,1,1),
	(238,'transcription','In the early 2000s, machine learning kind of took over. I mentioned that I studied artificial intelligence and there was this very known schism where some people would study machine learning because they liked the statistical approach and it had better results',259.693,1397186954,1397187024,30,1,1),
	(239,'transcription','And then people like me would study artificial intelligence just because it was fun, not because it had any practical use in industry or anything like that. I just really enjoyed it more than anything.',281.253,1397187026,1397187069,30,1,1),
	(240,'transcription','But I wasn\'t really following technology much at that point in time. I remember getting my first laptop and it was a Powerbook 12\".',294.583,1397187075,1397187120,30,1,1),
	(241,'transcription','Beyond that, I wasn\'t really following anything. It wasn\'t until I moved to DC where I actually kept my ear to the ground about what was going and tried to follow everything.',307.052,1397187121,1397187172,30,1,1),
	(242,'transcription','Q: Did you download music at this time?',340.042,1397187173,1397187227,30,1,1),
	(243,'transcription','No, I didn\'t. I\'ve never really pirated much of anything. I used to pirate software, but never music. I would try and find my music through friends for the most part. I\'ve never been big into pirating anything.',342.077,1397187230,1397187275,30,1,1),
	(244,'transcription','Q: Finding music through friends, were you copying files from them?',359.739,1397187276,1397187293,30,1,1),
	(245,'transcription','Usually...well yes, that\'s true. Not digital, well I guess it was digital. It was all CDs for the most part. Friends would make me CDs of random shit that I would listen to.',363.667,1397187293,1397187350,30,1,1),
	(246,'transcription','Q: That was at a time when pirating was big though?',378.625,1397187351,1397187389,30,1,1),
	(247,'transcription','Absolutely! All my friends were just downloading shit off of Napster left and right, but I never did for whatever reason.',384.789,1397187390,1397187421,30,1,1),
	(248,'transcription','I found all of my software off of IRC and I would download warez from IRC and trudge through the undernet to try and find whatever video game I wanted to play or whatever it was that I was looking for that day. I never used that for music for whatever reason.',394.482,1397187421,1397187486,30,1,1),
	(249,'transcription','[radio interference and banter]',412.445,1397187487,1397187567,30,1,1),
	(250,'transcription','Q: How were people\'s perception of how to acquire music changing?',468.327,1397187597,1397187641,30,1,1),
	(251,'transcription','Q: How did you get music back in the day?',492.5,1397187641,1397187691,30,1,1),
	(252,'transcription','Music is such a bad example for me because I literally bought music.',499.998,1397187707,1397187727,30,1,1),
	(253,'transcription','Q: What is that process of buying music then?',504.414,1397187728,1397187739,30,1,1),
	(254,'transcription','I would go into a store and I would look for an artist that I heard from a friend or wherever and I would go buy a CD and that would be the process by which I got my music.',508.987,1397187743,1397187775,30,1,1),
	(255,'transcription','Q; How were other people starting to get music at that point?',522.854,1397187776,1397187789,30,1,1),
	(256,'transcription','Kazaa was super popular, emule or edonkey was popular. It was all about peer-to-peer sharing at that point.',525.376,1397187790,1397187826,30,1,1),
	(257,'transcription','This was a little prior to BitTorrent coming out, so people were still using peer-to-peer sharers and ISP was blocking them.',538.928,1397187826,1397187883,30,1,1),
	(258,'transcription','All these crazy kids would get around them by changing the ports they were using to avoid that and still get access to the media they were after.',547.348,1397187884,1397187916,30,1,1),
	(259,'transcription','It was neat \'cuz I heard of so many more artists just through friends because they were surfing the net looking for anything and pulling whatever they could grab and listening to them.Â ',557.528,1397187918,1397187982,30,1,1),
	(260,'transcription','\"This sucks, this sucks, this sucks, this is great!\"',570.683,1397187982,1397187993,30,1,1),
	(261,'transcription','With that one great thing, they would just bring it to everyone they knew and just share it with everyone. It was totally rad, very interesting',571.689,1397187995,1397188029,30,1,1),
	(262,'transcription','So the tools are really accesible in a couple of different ways',165.452,1397241005,1397241020,52,5,5);
...
INSERT INTO `stories` (`id`, `order`, `title`, `story_text`)
VALUES
	(1,100000000,'The Opportunity of 3D Printing','Matthew Deupner, a 15-year-old hacker, introduces us to the 3D Printer that he built himself.  This device takes designs that he found on the internet and makes real, physical objects.  Home manufacturing is now a reality. Anyone can make with a simple downloadable file and a thingie-maker like this.'),
	(2,200000000,'A New Situation Found at The Maker Space','Matthew shares his ideas at his local hackerspace, a new kind of community workshop that are popping up all over the world.  At HackManhattan, hackers, makers, and DIYers share tools and ideas. Everyday people can make stuff themselves, and by learning from each other they can develop new ideas faster than industry can.'),
	(3,300000000,'The Maker Movement changes everything','Hackerspace members start publishing their ideas and meet at an annual show-and-tell called MakerFaire.  MakerFaire (and the surrounding Maker movement) is getting bigger every year, bigger than ever expected.  Here we find that some groups are using technology, free information, and collaboration to make a big impact.  FarmHack is one group making agriculture more resilient and sustainable. FarmHack members are changing agriculture with electronics, data, and informed techniques; and they are publishing this information publicly.'),
	(4,400000000,'The Speed of Rapid Protoyping','Digital design and rapid manufacturing are exciting new technologies for product designers like Dale Backus, the creator of the SmallHD monitor.  Cinematographers everywhere know the SmallHD monitor, a versatile video production tool which Dale and his friends first hacked together in their basement just a few years ago with some factory-leftover laptop displays. Now they use 3D printing to test out their product designs before going into production on their product, and assembly happens here in the USA.  This Rapid Prototyping business model enables them to make a product that can compete with industry giants like Sony and Panasonic, who use large overseas factories.  Small businesses of all kinds can benefit from this combination of tools and strategy.'),
	(5,500000000,'The Strength of Crowdsourcing','Group collaboration is now possible on a global scale.  By connecting online, people can pool their resources in a way that was once only feasible for corporations and governments.\n(Better Block Project scene)'),
	(6,600000000,'The Resilience of Open Source Information','Learn and share just about anything online.  This environment helps ideas develop faster than old business models. Collaboration, participation, and community can improve all aspects of our lives, according to OpenSource.com ?s manager, Jason Hibbets.  His vision for an Open-Source City is being tested out in the streets of Raleigh, where citizens are hacking public policy to work for them.'),
	(7,700000000,'The Complication of Intellectual Property','Not all ideas are free.  Copyright and Patents are a legal barrier to the free exchange of ideas. In the age where bits can become atoms, where is the line between free speech and intellectual property?  (Public Knowledge scene)'),
	(8,800000000,'The Challenge of Tactical Urbanism','The rules are broken everywhere.  Using the open source approach and guerrilla tactics, citizens are taking it upon themselves to change their cities.  Civic improvement is the of goal the Food Is Free project, a community activist group.  Involved citizens grow edible plants in front yards and public spaces everywhere, but are their unsanctioned projects a benefit or a nuisance?'),
	(9,900000000,'3D Printed Guns bring higher stakes','Some free ideas are dangerous.  Guns are now accessible to anyone with a 3D printer.  What could develop next?  (Cody Wilson scene)'),
	(10,1000000000,'The Push for Maker Education','In San Diego, the founders of FabLab SD are using technology for a cause.  With a grant from MIT, they are showing children how to use these emerging technologies, and teaching stewardship for using them responsibly.  The kids get it.  The great challenges of our time just might be solved by a generation of native makers who think differently about design, consumption, and collaboration.'),
	(11,1100000000,'Customization for everyone','A new economy is approaching.  This bazaar for products will be tailored to your specific needs, not mass-produced in a foreign factory. (TechShop scene)'),
	(12,1200000000,'The Coming Industrial Revolution','Now is the time to be excited.  We are creating a new economy, a new sense of democracy, and a new freedom brought by a mastery of technology once only dreamed of in science fiction.'),
	(13,0,NULL,'Just in the last few years, we have completely changed the way we create and consume music, movies, books, and news. Another change is coming, and this time it?s not just in the virtual world.'),
	(14,300000001,NULL,'An exciting new technology has been released from makerspaces across the world.\nPhysical things can be made with a free download anywhere with interconnectivity.'),
	(15,600000001,NULL,'Creators of all kinds have been empowered by this free exchange of ideas.  The technology is here.  People can make for themselves now.'),
	(16,900000001,NULL,'Existing law does not fit well with the new reality of free information, and the public now fears this liberating approach to technology.'),
	(17,1200000001,NULL,'Your input needed.\nHackers are re-making everything.\nYou too can start shaping your world.');
...
VALUES
	...
	(3,'joseph@thellama.us',0,'2014-02-27 10:23:06'),
	(5,'jeffrey@jburas.com',0,'2014-04-11 14:27:20');
